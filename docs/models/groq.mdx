---
title: "Groq - CodinIT"
description: Learn how to configure and use Groq models with CodinIT, including API key setup, supported models, and reasoning capabilities.
date: 2025-06-14
---

# xAI (Grok)

> Learn how to configure and use xAI's Grok models with CodinIT, including API key setup, supported models, and reasoning capabilities.
