---
title: "Ollama - CodinIT"
description: Learn how to configure and use Ollama models with CodinIT, including setup, model selection, and context window configuration.
date: 2025-06-14
---
