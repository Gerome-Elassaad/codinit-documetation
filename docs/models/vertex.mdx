---
title: 'GCP Vertex AI - CodinIT'
description: Configure GCP Vertex AI with CodinIT to access leading generative AI models like Claude 3.5 Sonnet v2.
date: 2025-06-14
---

# GCP Vertex AI

> Configure GCP Vertex AI with CodinIT to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams.
...
*This guide will be updated as GCP Vertex AI and CodinIT evolve. Always refer to the latest documentation for current practices.*
